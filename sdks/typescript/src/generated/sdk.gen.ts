 ...
 *
 */
export const postAnalysisAnalyzeText = <ThrowOnError extends boolean = false>(options: Options<PostAnalysisAnalyzeTextData, ThrowOnError>) => {
    return (options.client ?? client).post<PostAnalysisAnalyzeTextResponses, PostAnalysisAnalyzeTextErrors, ThrowOnError>({
        responseType: 'json',
        security: [
            {
                scheme: 'bearer',
