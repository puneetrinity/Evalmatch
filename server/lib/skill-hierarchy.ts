...
> = {
  ...
  // PHARMACEUTICAL CERTIFICATIONS & CREDENTIALS
  ccrp: {
    normalized: "Certified Clinical Research Professional",
    category: SKILL_CATEGORIES.CLINICAL_RESEARCH,
    aliases: ["ccrp", "acrp certification", "clinical research certification"],
    relatedSkills: ["Clinical Research", "GCP", "Clinical Trials"],
  },
  ccrc: {
    normalized: "Certified Clinical Research Coordinator",
    category: SKILL_CATEGORIES.CLINICAL_RESEARCH,
    aliases: ["ccrc", "socra certification", "clinical coordinator certification"],
    relatedSkills: ["Clinical Research", "Site Management", "Patient Recruitment"],
  },
  scdm: {
    normalized: "Clinical Data Management Certification",
    category: SKILL_CATEGORIES.CLINICAL_RESEARCH,
    aliases: ["scdm certification", "clinical data manager certification"],
    relatedSkills: ["Clinical Data Management", "EDC", "Data Quality"],
  },
  rac: {
    normalized: "Regulatory Affairs Certification",
    category: SKILL_CATEGORIES.REGULATORY_AFFAIRS,
    aliases: ["rac", "raps certification", "regulatory certification"],
    relatedSkills: ["Regulatory Affairs", "FDA Regulations", "Drug Registration"],
  },
  seniorrac: {
    normalized: "Senior Regulatory Affairs Certification",
    category: SKILL_CATEGORIES.REGULATORY_AFFAIRS,
    aliases: ["senior rac", "advanced regulatory certification"],
    relatedSkills: ["Regulatory Affairs", "RAC", "Regulatory Strategy"],
  },
  cqa: {
    normalized: "Certified Quality Auditor",
    category: SKILL_CATEGORIES.QUALITY_ASSURANCE_PHARMA,
    aliases: ["cqa", "asq quality auditor", "quality audit certification"],
    relatedSkills: ["Quality Auditing", "ISO 9001", "Quality Systems"],
  },
  cqe: {
    normalized: "Certified Quality Engineer",
    category: SKILL_CATEGORIES.QUALITY_ASSURANCE_PHARMA,
    aliases: ["cqe", "asq quality engineer", "quality engineering certification"],
    relatedSkills: ["Quality Engineering", "Statistical Quality Control", "Process Improvement"],
  },
  cpgp: {
    normalized: "Certified Pharmaceutical GMP Professional",
    category: SKILL_CATEGORIES.QUALITY_ASSURANCE_PHARMA,
    aliases: ["cpgp", "pda gmp certification", "pharmaceutical gmp certification"],
    relatedSkills: ["GMP", "Quality Assurance", "Manufacturing Quality"],
  },
  leansixsigma: {
    normalized: "Lean Six Sigma",
    category: SKILL_CATEGORIES.PROJECT_MANAGEMENT,
    aliases: ["lean six sigma", "green belt", "black belt", "process improvement"],
    relatedSkills: ["Process Improvement", "Quality Management", "Statistical Analysis"],
  },
  cpip: {
    normalized: "Certified Pharmaceutical Industry Professional",
    category: SKILL_CATEGORIES.PHARMACEUTICAL_MANUFACTURING,
    aliases: ["cpip", "ispe certification", "pharmaceutical engineering certification"],
    relatedSkills: ["Pharmaceutical Engineering", "Manufacturing", "Process Design"],
  },
  cpp: {
    normalized: "Certified Pharmacovigilance Professional",
    category: SKILL_CATEGORIES.PHARMACOVIGILANCE,
    aliases: ["cpp", "dia pharmacovigilance certification", "drug safety certification"],
    relatedSkills: ["Pharmacovigilance", "Drug Safety", "Adverse Event Reporting"],
  },
  gvp: {
    normalized: "Good Pharmacovigilance Practices Certification",
    category: SKILL_CATEGORIES.PHARMACOVIGILANCE,
    aliases: ["gvp certification", "pharmacovigilance practices"],
    relatedSkills: ["Pharmacovigilance", "EU Regulations", "Safety Surveillance"],
  },
  mslscertification: {
    normalized: "Medical Science Liaison Certification",
    category: SKILL_CATEGORIES.MEDICAL_AFFAIRS,
    aliases: ["msls certification", "medical liaison certification"],
    relatedSkills: ["Medical Science Liaison", "KOL Management", "Medical Affairs"],
  },
  cmpp: {
    normalized: "Certified Medical Publication Professional",
    category: SKILL_CATEGORIES.MEDICAL_AFFAIRS,
    aliases: ["cmpp", "medical writing certification", "publication certification"],
    relatedSkills: ["Medical Writing", "Scientific Publications", "Medical Communications"],
  },
  cpsr: {
    normalized: "Certified Pharmaceutical Sales Representative",
    category: SKILL_CATEGORIES.PHARMACEUTICAL_SALES,
    aliases: ["cpsr", "pharmaceutical sales certification"],
    relatedSkills: ["Pharmaceutical Sales", "Product Knowledge", "Customer Engagement"],
  },
  cfa: {
    normalized: "Chartered Financial Analyst",
    category: SKILL_CATEGORIES.BUSINESS,
    aliases: ["cfa", "chartered financial analyst", "investment analysis certification"],
    relatedSkills: ["Financial Analysis", "Investment Management", "Portfolio Management"],
  },
  cbdp: {
    normalized: "Certified Business Development Professional",
    category: SKILL_CATEGORIES.BUSINESS,
    aliases: ["cbdp", "business development certification"],
    relatedSkills: ["Business Development", "Strategic Planning", "Partnership Management"],
  },
  cscp: {
    normalized: "Certified Supply Chain Professional",
    category: SKILL_CATEGORIES.SUPPLY_CHAIN,
    aliases: ["cscp", "apics supply chain certification"],
    relatedSkills: ["Supply Chain Management", "Logistics", "Demand Planning"],
  },
  cpim: {
    normalized: "Certified in Production and Inventory Management",
    category: SKILL_CATEGORIES.SUPPLY_CHAIN,
    aliases: ["cpim", "apics production certification", "inventory management certification"],
    relatedSkills: ["Inventory Management", "Production Planning", "Supply Chain"],
  },
  cpsm: {
    normalized: "Certified Professional in Supply Management",
    category: SKILL_CATEGORIES.SUPPLY_CHAIN,
    aliases: ["cpsm", "supply management certification", "procurement certification"],
    relatedSkills: ["Procurement", "Supply Management", "Vendor Management"],
  },
  pmp: {
    normalized: "Project Management Professional",
    category: SKILL_CATEGORIES.PROJECT_MANAGEMENT,
    aliases: ["pmp", "pmi certification", "project management certification"],
    relatedSkills: ["Project Management", "Risk Management", "Stakeholder Management"],
  },
  prince2: {
    normalized: "PRINCE2 Practitioner",
    category: SKILL_CATEGORIES.PROJECT_MANAGEMENT,
    aliases: ["prince2", "prince2 practitioner", "structured project management"],
    relatedSkills: ["Project Management", "Process Management", "Risk Management"],
  },
  csm: {
    normalized: "Certified ScrumMaster",
    category: SKILL_CATEGORIES.PROJECT_MANAGEMENT,
    aliases: ["csm", "scrum master certification", "agile certification"],
    relatedSkills: ["Scrum", "Agile Methodology", "Team Leadership"],
  },
  uspformulation: {
    normalized: "USP Certified Formulation Scientist",
    category: SKILL_CATEGORIES.DRUG_DISCOVERY,
    aliases: ["usp formulation certification", "formulation scientist certification"],
    relatedSkills: ["Formulation Science", "USP Standards", "Drug Development"],
  },
  cpa: {
    normalized: "Certified Pharmaceutical Analyst",
    category: SKILL_CATEGORIES.QUALITY_ASSURANCE_PHARMA,
    aliases: ["cpa", "pda analyst certification", "pharmaceutical analyst certification"],
    relatedSkills: ["Analytical Chemistry", "Method Validation", "Quality Control"],
  },
  iso17025: {
    normalized: "ISO/IEC 17025 Lead Auditor",
    category: SKILL_CATEGORIES.QUALITY_ASSURANCE_PHARMA,
    aliases: ["iso 17025", "laboratory accreditation", "testing laboratory certification"],
